...
public class FreeMarkerTest {
	...
	public void testFreeMarker() throws Exception {
		...
		configuration.setDirectoryForTemplateLoading(
				new File("E:\\eclipse_neon_workspcae\\taotao-portal\\src\\main\\webapp\\WEB-INF\\ftl"));
		...
		Writer out = new FileWriter(new File("E:\\eclipse_neon_workspcae\\taotao-portal\\src\\main\\webapp\\WEB-INF\\ftl\\first.ftl"));
